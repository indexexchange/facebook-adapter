        ...
        if (partnerConfig.mapping.hasOwnProperty(htSlotName)) {
            ...
            for (var i = 0; i < xSlotsArray.length; i++) {
                ...
                returnParcels.push({
                    ...
                    size: partnerConfig.xSlots[xSlotName].size,
                    adformat: partnerConfig.xSlots[xSlotName].adformat
                });
            }
        }
    }
...
describe('parseResponse', function () {
    ...
    var partnerModule = proxyquire('../facebook-htb.js', libraryStubData);
    ...
    var returnParcels, unusedReturnParcels;
    ...
    describe('should correctly parse bids:', function () {
        ...
        beforeEach(function () {
            ...
            unusedReturnParcels = returnParcels.map(rp => rp.htSlot.id);
        ...
        it('each parcel should have the required fields set', function () {
            ...
            if (partnerProfile.architecture) partnerModule.parseResponse(1, mockData, returnParcels, unusedReturnParcels);

            for (var i = 0; i < returnParcels.length; i++) {

                /* IF MRA, parse one parcel at a time */
                if (!partnerProfile.architecture) partnerModule.parseResponse(1, mockData[i], [returnParcels[i]], unusedReturnParcels);
        ...
        it('registerAd should be called with correct adEntry', function () {
            ...
            if (partnerProfile.architecture === 1 || partnerProfile.architecture === 2) {
                ...
                partnerModule.parseResponse(1, mockData, returnParcels, unusedReturnParcels);
                ...
                for (var i = 0; i < mockData.length; i++) {
                    ...
                    partnerModule.parseResponse(1, mockData[i], [returnParcels[i]], unusedReturnParcels);
